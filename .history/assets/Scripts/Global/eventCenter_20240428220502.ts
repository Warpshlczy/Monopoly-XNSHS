...
export const eventCenter = {
  ...
  localGame: {
    ...
    initPlayer: function () {
      ...
      (center.PlayerZone_2.$player as player).setAll(2, "你", true, 1500);
      (center.PlayerZone_3.$player as player).setAll(3, "你", true, 1500);
      (center.PlayerZone_4.$player as player).setAll(1, "你", true, 1500);
    },
  },
};
type ManagerEvent = {
