...
export const eventCenter = {
  ...
  localGame: {
    ...
    initPlayer: function () {
      ...
      log(center)(center.PlayerZone_1.$player as player).setAll(
        1,
        "你",
        true,
        1500
      );
      center.PlayerZone_1.PlayerMegBox.Name.string = "你";
      for (let i = 2; i < 5; i++) {
        center[`PlayerZone_${i}`].$player.setAll(i, "AI玩家" + i, false, 1500);
        center[`PlayerZone_${i}`].PlayerMegBox.Name.string = "AI玩家" + i;
      }
    },
  },
};
