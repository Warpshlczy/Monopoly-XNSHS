...
export const eventCenter = {
  ...
  localGame: {
    ...
    initPlayer: function () {
      ...
      (center.PlayerZone_0.$player as player).setAll(1, "你", true, 1500);
      (center.PlayerZone_1.$player as player).setAll(2, "你", true, 1500);
      (center.PlayerZone_2.$player as player).setAll(3, "你", true, 1500);
      (center.PlayerZone_3.$player as player).setAll(1, "你", true, 1500);
    },
  },
};
type ManagerEvent = {
